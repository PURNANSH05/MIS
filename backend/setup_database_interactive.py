#!/usr/bin/env python3
"""
Interactive Database Setup - Ask for password
"""
...
try:
    ...
    print("\nMake sure you entered the correct PostgreSQL password.")
    exit(1)
...
try:
    ...
    env_content = env_content.replace("DB_PASSWORD=2006", f"DB_PASSWORD={password}")
